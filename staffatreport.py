...
class Staffatreport(Toplevel):
    ...
    def __init__(self, root, main_root):
        ...
        self.reportbutton = Button(self.lf2, text="Genrate Report", bd=5, font=(self.f2, 15), command=self.atreport)
        self.reportbutton.place(x=500, y=400, height=25)
